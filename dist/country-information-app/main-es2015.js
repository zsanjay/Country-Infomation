...
const routes = [
    { path: '', component: _components_countries_countries_component__WEBPACK_IMPORTED_MODULE_3__["HomeComponent"] },
    { path: 'detail/:name/:compare', component: _components_detail_detail_component__WEBPACK_IMPORTED_MODULE_4__["DetailComponent"] }
];
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_detail_detail_component__WEBPACK_IMPORTED_MODULE_6__["DetailComponent"],
            _components_countries_countries_component__WEBPACK_IMPORTED_MODULE_7__["HomeComponent"]
        ],
        imports: [
...
/* harmony import */ var src_app_search_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/search.service */ "./src/app/search.service.ts");
...
let DetailComponent = class DetailComponent {
    ...
    ngOnInit() {
        if (!this.compare) {
            this.searchService.getCountryDetailsByName(this.name).subscribe((countryData) => {
            ...
            this.cards = [];
            this.searchService.getAllCountries().subscribe((countryData) => {
                countryData.forEach(data => {
...
module.exports = __webpack_require__(/*! /Users/sanjaysmacbook/Documents/Angular/country-information-app/src/main.ts */"./src/main.ts");
